...
🇬🇧&nbsp; A **full-stack software developer** building scalable enterprise systems. Clean architecture, DDD and microservices with **.NET / ABP** on the backend; clean, fast interfaces with **Vue** and **React** on the frontend. I care about code quality, performance and maintainability.
